...
public class QBResults {
    ...
    public QBResults() {
        ...
        results.get("messages").get(0).put("status_code", DBResponses.INTERNAL_SERVER_ERROR.getCode());
    ...
    public QBResults setMessage(DBResponses DBResponses) {
        if (results.get("messages") != null) {
            results.get("messages").get(0).put("status_code", DBResponses.getCode());
            results.get("messages").get(0).put("message", DBResponses.getMessage());
            return this;
        }
        return null;
    }
